defmodule PhxIconsDemoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(PhxIconsDemoWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(PhxIconsDemoWeb.Gettext, "errors", msg, opts)
    # end
